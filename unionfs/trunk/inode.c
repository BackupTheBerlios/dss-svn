 ...
 */
/*
 *  $Id: inode.c,v 1.233 2005/09/21 12:30:50 cwright Exp $
 */
...
#if 0 /* Needs to be skipped, since we are only interested in the files permission, not in the file systems ro status */
