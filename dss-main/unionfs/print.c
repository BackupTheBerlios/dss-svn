 ...
 */
/*
 *  $Id: print.c,v 1.68 2005/11/20 23:03:34 arunmk Exp $
 */
...
/* The following doesn't seem to be used by anyone anymore */
/*
static void fist_print_pte_flags(char *str, const struct page *page)
{
