 ...
 */
/*
 *  $Id: file.c,v 1.128 2005/11/20 23:03:34 arunmk Exp $
 */
...
extern ssize_t unionfs_read(struct file *, char *, size_t, loff_t *);
extern ssize_t unionfs_write(struct file *, const char *, size_t, loff_t *);
